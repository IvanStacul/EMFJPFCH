...
<h1 class="m-0 text-dark text-bold">Nuevo Video</h1>
@endsection
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      ...
      <div class="card-header">
        <h3 class="card-title">Ingrese los datos del video</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form class="form-horizontal" method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <label for="link" class="col-sm-2 col-form-label">Link del video <span style="color:red">*</span> </label>
            <div class="col-sm-10">
              <input required type="text" id="link" class="form-control" name="link" placeholder="Ingrese el link del video ..."
                value="{{ old('link', $video->link ? "https://youtu.be/".$video->link : $video->link) }}">
            </div>
          </div> <!-- /.link -->
