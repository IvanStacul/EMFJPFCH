...
<h1 class="m-0 text-dark text-bold">Nueva Autoridad</h1>
@endsection
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      ...
      <div class="card-header">
        <h3 class="card-title">Ingrese los datos de la autoridad</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form class="form-horizontal" method="POST" action="{{ route('autoridades.store') }}"
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              ...
              <input type="number" id="weight" class="form-control" name="weight" value="{{ old('weight', 0 ) }}">
            </div>
            ...
            <div class="col-md-6">
              ...
              <select class="form-control" name="group" id="group">
                ...
                <option value="directivo"> Comisión directiva </option>
                <option value="cuentas"> Comisión Revisora de Cuentas </option>
                <option value="disciplina"> Tribunal de Disciplina </option>
              </select>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="appointed" checked>
